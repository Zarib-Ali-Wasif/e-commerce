        ...
        <Box>
          <Box mt={10} mb={10} p={3} sx={{ minHeight: "70vh", height: "100%" }}>
            ...
            <Typography variant="body1" mt={2} textAlign="justify">
              ...
              home essentials, or unique gift ideas, <strong>ShopEasy</strong>{" "}
              has it all. Our commitment to quality ensures that every product
              in our catalog meets the highest standards, giving you the
              confidence to shop with ease.
            </Typography>
            <Typography variant="body1" mt={2} textAlign="justify">
              ...
              browsing and buying a breeze. Our team is dedicated to ensuring
            ...
            <Typography variant="body1" mt={2} textAlign="justify">
              ...
              experience that’s tailored just for you. Your journey to finding
              the perfect products begins here, and we’re thrilled to have you
